...
<head>
<meta charset="utf-8" />
<title>/plotCQT.m - Constant-Q Transform Toolbox - Sound Software .ac.uk</title>
...
<form accept-charset="UTF-8" action="/projects/constant-q-toolbox/repository/entry/plotCQT.m" id="revision_selector" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>  <!-- Branches Dropdown -->
    | 分支: 
...
<h2><a href="/projects/constant-q-toolbox/repository">root</a>
    / <a href="/projects/constant-q-toolbox/repository/changes/plotCQT.m">plotCQT.m</a>
...
<p>
<a href="/projects/constant-q-toolbox/repository/changes/plotCQT.m">历史记录</a> |
    查看 |
    <a href="/projects/constant-q-toolbox/repository/annotate/plotCQT.m">追溯</a> |
<a href="/projects/constant-q-toolbox/repository/raw/plotCQT.m">下载</a>
(1.77 KB)
</p>
...
<tbody>
  <tr id="L1">
    ...
    <td class="line-code">
      <pre>function plotCQT(Xcqt,fs,fcomp,method)
</pre>
    </td>
  </tr>
  <tr id="L2">
    ...
    <td class="line-code">
      <pre>%plotCQT(Xcqt,fs,fcomp,method) plots the magnitudes of the CQT 
</pre>
    </td>
  </tr>
  <tr id="L3">
    ...
    <td class="line-code">
      <pre>%coefficients similar to a spectrogram using linear interpolation 
</pre>
    </td>
  </tr>
  <tr id="L4">
    ...
    <td class="line-code">
      <pre>%between the calculated coefficients. For better illustration, the
</pre>
    </td>
  </tr>
  <tr id="L5">
    ...
    <td class="line-code">
      <pre>%magnitude values can be compressed using fcomp &lt; 1 (Xmag^fcomp).
</pre>
    </td>
  </tr>
  <tr id="L6">
    ...
    <td class="line-code">
      <pre>%For generating the figure &#x27;method&#x27; can be set to &#x27;surf&#x27; and
</pre>
    </td>
  </tr>
  <tr id="L7">
    ...
    <td class="line-code">
      <pre>%&#x27;image&#x27;, respectively, whereas using &#x27;surf&#x27; the axis are properly labeled, 
</pre>
    </td>
  </tr>
  <tr id="L8">
    ...
    <td class="line-code">
      <pre>%however &#x27;image&#x27; is faster leaving all axis unlabeled (default: &#x27;surf&#x27;).
</pre>
    </td>
  </tr>
  <tr id="L9">
  ...
  <tr id="L13">
    ...
    <td class="line-code">
      <pre>    absCQT = getCQT(Xcqt,&#x27;all&#x27;,&#x27;all&#x27;,&#x27;linear&#x27;);
</pre>
    </td>
  </tr>
  <tr id="L14">
  ...
  <tr id="L18">
    ...
    <td class="line-code">
      <pre>emptyHops = Xcqt.intParams.firstcenter/Xcqt.intParams.atomHOP;
</pre>
    </td>
  </tr>
  <tr id="L19">
    ...
    <td class="line-code">
      <pre>maxDrop = emptyHops*2^(Xcqt.octaveNr-1)-emptyHops;
</pre>
    </td>
  </tr>
  <tr id="L20">
    ...
    <td class="line-code">
      <pre>droppedSamples = (maxDrop-1)*Xcqt.intParams.atomHOP + Xcqt.intParams.firstcenter;
</pre>
    </td>
  </tr>
  <tr id="L21">
    ...
    <td class="line-code">
      <pre>outputTimeVec = (1:size(absCQT,2))*Xcqt.intParams.atomHOP-Xcqt.intParams.preZeros+droppedSamples;
</pre>
    </td>
  </tr>
  <tr id="L22">
  ...
  <tr id="L23">
    ...
    <td class="line-code">
      <pre>if nargin &lt; 4, method = &#x27;surf&#x27;; end;
</pre>
    </td>
  </tr>
  <tr id="L24">
  ...
  <tr id="L27">
    ...
    <td class="line-code">
      <pre>    X_cq_rast = absCQT.^fcomp; %compress magnitudes
</pre>
    </td>
  </tr>
  <tr id="L28">
    ...
    <td class="line-code">
      <pre>    surf(outputTimeVec./fs,1:size(X_cq_rast,1),X_cq_rast,&#x27;EdgeColor&#x27;,&#x27;none&#x27;);
</pre>
    </td>
  </tr>
  <tr id="L29">
    ...
    <td class="line-code">
      <pre>    caxis([min(min(X_cq_rast)) max(max(X_cq_rast))]);
</pre>
    </td>
  </tr>
  <tr id="L30">
  ...
  <tr id="L31">
    ...
    <td class="line-code">
      <pre>    set(gca,&#x27;YTick&#x27;,1:Xcqt.bins/2:Xcqt.octaveNr*Xcqt.bins);
</pre>
    </td>
  </tr>
  <tr id="L32">
  ...
  <tr id="L33">
    ...
    <td class="line-code">
      <pre>    yTickLabel = num2str(round(Xcqt.fmin*2.^((yTick-1)/Xcqt.bins)),5);
</pre>
    </td>
  </tr>
  <tr id="L34">
    ...
    <td class="line-code">
      <pre>    set(gca,&#x27;YTickLabel&#x27;,yTickLabel);
</pre>
    </td>
  </tr>
  <tr id="L35">
    ...
    <td class="line-code">
      <pre>    xlabel(&#x27;time [sec]&#x27;); ylabel(&#x27;frequency [Hz]&#x27;);
</pre>
    </td>
  </tr>
  <tr id="L36">
  ...
  <tr id="L38">
    ...
    <td class="line-code">
      <pre>    %set(gcf,&#x27;Colormap&#x27;,whiteblack1)
</pre>
    </td>
  </tr>
  <tr id="L39">
    ...
    <td class="line-code">
      <pre>    title(&#x27;Constant Q transform&#x27;,&#x27;FontSize&#x27;,12);
</pre>
    </td>
  </tr>
  <tr id="L40">
  ...
  <tr id="L43">
    ...
    <td class="line-code">
      <pre>    X_cq_rast = flipud(X_cq_rast);
</pre>
    </td>
  </tr>
  <tr id="L44">
