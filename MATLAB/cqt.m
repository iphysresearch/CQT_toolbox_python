...
<head>
<meta charset="utf-8" />
<title>/cqt.m - Constant-Q Transform Toolbox - Sound Software .ac.uk</title>
...
<form accept-charset="UTF-8" action="/projects/constant-q-toolbox/repository/entry/cqt.m" id="revision_selector" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>  <!-- Branches Dropdown -->
    | 分支: 
...
<h2><a href="/projects/constant-q-toolbox/repository">root</a>
    / <a href="/projects/constant-q-toolbox/repository/changes/cqt.m">cqt.m</a>
...
<p>
<a href="/projects/constant-q-toolbox/repository/changes/cqt.m">历史记录</a> |
    查看 |
    <a href="/projects/constant-q-toolbox/repository/annotate/cqt.m">追溯</a> |
<a href="/projects/constant-q-toolbox/repository/raw/cqt.m">下载</a>
(5.275 KB)
</p>
...
<tbody>
  <tr id="L1">
    ...
    <td class="line-code">
      <pre>function Xcqt = cqt(x,fmin,fmax,bins,fs,varargin) 
</pre>
    </td>
  </tr>
  <tr id="L2">
    ...
    <td class="line-code">
      <pre>%Xcqt = cqt(x,fmin,fmax,bins,fs,varargin) calculates the constant-Q transform of the input signal x.
</pre>
    </td>
  </tr>
  <tr id="L3">
  ...
  <tr id="L59">
    ...
    <td class="line-code">
      <pre>for ain = 1:1:length(varargin)
</pre>
    </td>
  </tr>
  <tr id="L60">
  ...
  <tr id="L83">
    ...
    <td class="line-code">
      <pre>    cqtKernel = genCQTkernel(fmax, bins,fs,&#x27;q&#x27;,q,&#x27;atomHopFactor&#x27;,atomHopFactor,&#x27;thresh&#x27;,thresh,&#x27;win&#x27;,winFlag);
</pre>
    </td>
  </tr>
  <tr id="L84">
  ...
  <tr id="L93">
    ...
    <td class="line-code">
      <pre>K = cqtKernel.fKernel&#x27;; %conjugate spectral kernel for cqt transformation
</pre>
    </td>
  </tr>
  <tr id="L94">
  ...
  <tr id="L98">
    ...
    <td class="line-code">
      <pre>    cellCQT{i} = K*XX; %calculating cqt coefficients for all FFT frames for this octave
</pre>
    </td>
  </tr>
  <tr id="L99">
  ...
  <tr id="L106">
    ...
    <td class="line-code">
      <pre>%% map to sparse matrix representation
</pre>
    </td>
  </tr>
  <tr id="L107">
    ...
    <td class="line-code">
      <pre>spCQT = cell2sparse(cellCQT,octaveNr,bins,cqtKernel.firstcenter,cqtKernel.atomHOP,cqtKernel.atomNr);
</pre>
    </td>
  </tr>
  <tr id="L108">
  ...
  <tr id="L112">
    ...
    <td class="line-code">
      <pre>    &#x27;atomNr&#x27;,cqtKernel.atomNr,&#x27;Nk_max&#x27;,cqtKernel.Nk_max,&#x27;Q&#x27;,cqtKernel.Q,&#x27;rast&#x27;,0);
</pre>
    </td>
  </tr>
  <tr id="L113">
  ...
  <tr id="L114">
    ...
    <td class="line-code">
      <pre>Xcqt = struct(&#x27;spCQT&#x27;,spCQT,&#x27;fKernel&#x27;,cqtKernel.fKernel,&#x27;fmax&#x27;,fmax,&#x27;fmin&#x27;,fmin,&#x27;octaveNr&#x27;,octaveNr,&#x27;bins&#x27;,cqtKernel.bins,&#x27;intParams&#x27;,intParam);
</pre>
    </td>
  </tr>
  <tr id="L115">
